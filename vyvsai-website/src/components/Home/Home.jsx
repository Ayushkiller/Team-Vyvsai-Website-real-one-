      ...
      <div className="container rounded-3">
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="testimonial">
              <p className="text-justify">
                "Vyvsai's SaaS model has been invaluable for us. It not only
                helps us fill out and submit bids efficiently but also
                accurately predicts bid outcomes, giving us a significant
                advantage. The free trial in Himachal Pradesh has proven to be a
                game-changer."
              </p>
            </div>
          </div>
